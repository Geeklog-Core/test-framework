...
class xmldbClassTest extends PHPUnit_Framework_TestCase 
{
    ...
    public function testGetCONF() {
        $dummy = array(
                    ...
                    'path_log' => '&quot;'.getPath('restricted').'/logs/&quot;;',
                    'path_language' => '&quot;'.getPath('restricted').'/language/&quot;;',
                    'backup_path' => '&quot;'.getPath('restricted').'/backups/&quot;;',
                    'path_data' => '&quot;'.getPath('restricted').'/data/&quot;;',
                    'path_images' => '&quot;'.getPath('public').'/images/&quot;;',
                    'fs_pear' => unserialize('N;'),
                    'have_pear' => unserialize('b:0;'),
                    'path_pear' => '&quot;'.getPath('restricted').'/system/pear/&quot;;',
        ...
        $CONF = $this->x->getCONF();
        $i = 0;
        foreach($CONF as $k => unserialize($v) {
            $i++;
