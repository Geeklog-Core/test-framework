...
// | config.class.php                                                          |
// |                                                                           |
// | Replacement config.class for PHPUnit test suite, called in lib-common     |
// +---------------------------------------------------------------------------+
...
class config {
    ...
    function &initConfig()
    {
        ...
        $this->config_array['Core']['path_system'] = getPath('tests').'files/dummy/system/';
		$this->config_array['Core']['path'] = getPath('tests').'files/dummy/';
