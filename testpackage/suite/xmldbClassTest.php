...
class xmldbClassTest extends PHPUnit_Framework_TestCase 
{
    ...
    public function testGet_CONF() {
        $dummy = array(
                    ...
                    'rdf_file' => Tst::$public.'backend/geeklog.rss',
                    ...
                    'path_html' => Tst::$public.'',
                    'path_log' => Tst::$root.'logs/',
                    'path_language' => Tst::$root.'language/',
                    'backup_path' => Tst::$root.'backups/',
                    'path_data' => Tst::$root.'data/',
                    'path_images' => Tst::$public.'images/',
                    'fs_pear' => unserialize('N;'),
                    'have_pear' => unserialize('b:0;'),
                    'path_pear' => Tst::$root.'system/pear/',
