...
class xmldbClassTest extends PHPUnit_Framework_TestCase 
{
    ...
    public function testGet_CONF() {
        $dummy = array(
                    ...
                    'rdf_file' => TestConfig::$public.'backend/geeklog.rss',
                    ...
                    'path_html' => TestConfig::$public.'',
                    'path_log' => TestConfig::$root.'logs/',
                    'path_language' => TestConfig::$root.'language/',
                    'backup_path' => TestConfig::$root.'backups/',
                    'path_data' => TestConfig::$root.'data/',
                    'path_images' => TestConfig::$public.'images/',
                    'fs_pear' => unserialize('N;'),
                    'have_pear' => unserialize('b:0;'),
                    'path_pear' => TestConfig::$root.'system/pear/',
                    ...
                    'path_themes' => TestConfig::$public.'layout/',
